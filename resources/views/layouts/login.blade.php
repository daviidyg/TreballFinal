...
<body style="background-size:cover; background-image:url('http://precolumbianweapons.com/wp-content/uploads/2018/11/warhammer-40k-aircraft-inspirational-wallpaper-warhammer-40k-orc-spaceship-aircraft-plane-art-of-warhammer-40k-aircraft.jpg')">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                                <a class="nav-link" {{ url('noticias/all/') }}>{{ __('Noticias') }}</a>
                            </li>
                            <li class="nav-item">
                                    <a class="nav-link" href="{{ route('login') }}">{{ __('Figuras') }}</a>
                                </li>
                        @guest
                            <li class="nav-item">
